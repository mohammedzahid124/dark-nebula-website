...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    // Type narrowing: canvas is now guaranteed to be non-null
    ...
    const { gl, ext }: any = getWebGLContext(canvasElement);
    ...
    function resizeCanvas() {
      let width = scaleByPixelRatio(canvasElement.clientWidth);
      let height = scaleByPixelRatio(canvasElement.clientHeight);
    ...
    function drawDisplay(target: any) {
      let width: number = target == null ? gl.drawingBufferWidth : target.width || gl.drawingBufferWidth;
      let height: number = target == null ? gl.drawingBufferHeight : target.height || gl.drawingBufferHeight;
