...
export default function About() {
  ...
  return (
    <section id="about" className="min-h-screen bg-black py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/3 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDuration: "4s" }} />
      </div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="mb-20 text-center">
          ...
          <p className="text-gray-300 text-lg max-w-3xl mx-auto leading-relaxed mb-4">
            We're a specialized AI and backend engineering firm. Built by engineers who ship production systems—not prototypes. We turn cutting-edge AI and cloud architecture into business impact.
          </p>
          <p className="text-gray-400 text-base max-w-3xl mx-auto leading-relaxed">
            From autonomous AI agents to enterprise-grade cloud infrastructure, we've delivered production systems that matter. Our work spans international clients across industries—from chemical manufacturing to advanced AI applications. We don't build features; we architect solutions that scale, perform, and drive measurable business outcomes.
          </p>
        </div>
                ...
                <div className="relative p-8 md:p-10">
                  ...
                  <div className="flex justify-center mb-8">
                    <div className="relative">
                      ...
                      <div className="absolute inset-0 rounded-full bg-linear-to-r from-purple-500 to-cyan-500 animate-spin-slow opacity-75" style={{ animationDuration: "20s" }} />
                  ...
                  <div className="text-center mb-6">
                    ...
                    <p className="text-purple-300 font-semibold text-base mb-1">{founder.title}</p>
                    <p className="text-cyan-300 text-sm font-medium">{founder.role}</p>
                  </div>
                  ...
                  {/* Expertise */}
                  <div className="mb-6">
                    <h4 className="text-xs font-semibold text-gray-400 mb-3 uppercase tracking-widest">Core Expertise</h4>
                  ...
                  <div className="flex justify-center gap-3 pt-6 border-t border-white/10">
                    ...
                    >
                      <svg className="w-5 h-5 text-white group-hover/social:text-purple-300 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    >
                      <svg className="w-5 h-5 text-white group-hover/social:text-cyan-300 transition-colors" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-white/10 pt-20 mb-24">
          <div className="relative group">
            ...
            <div className="relative bg-linear-to-r from-purple-500/10 to-cyan-500/10 border border-white/20 rounded-3xl p-8 md:p-12 group-hover:border-purple-500/50 transition-all duration-300">
              <h3 className="text-3xl font-bold text-white mb-6 text-center">Our Philosophy</h3>
              <div className="max-w-4xl mx-auto">
                <p className="text-gray-300 leading-relaxed text-center mb-6">
                  We combine advanced AI capabilities with enterprise-grade backend engineering. Every system we build is designed for production from day one—scalable, secure, and measurable in business impact.
                </p>
                <p className="text-gray-300 leading-relaxed text-center">
                  Our track record spans autonomous AI systems, cloud infrastructure, data engineering, and machine learning solutions delivered to international clients. We don't just code—we architect solutions that shape industries.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="relative p-8 md:p-12">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  ...
                  <div>
                    ...
                    <h4 className="text-3xl md:text-4xl font-bold text-white mb-4">ElementSphere</h4>
                    <p className="text-cyan-300 font-semibold mb-4">Chemical Manufacturing & Distribution Platform</p>
                    <p className="text-gray-300 mb-6 leading-relaxed">
                      A full-stack Next.js platform built for a Saudi-based chemical manufacturing and distribution company. ElementSphere revolutionizes how chemical products are managed, showcased, and distributed across international markets.
                    </p>
                    <p className="text-gray-400 text-sm mb-6 leading-relaxed">
                      The platform combines modern web architecture with enterprise-grade performance, delivering a seamless experience for product management, client relations, and supply chain operations. Built with scalability and international standards in mind.
                    </p>
                    <div className="mb-6">
                      <h5 className="text-xs font-semibold text-gray-400 mb-3 uppercase tracking-widest">Technologies</h5>
                      <div className="flex flex-wrap gap-2">
                        {["Next.js", "React", "TypeScript", "Tailwind CSS", "Node.js", "Cloud Infrastructure"].map((tech, i) => (
                          <span
                            key={i}
                  ...
                  {/* Project Visual */}
                  <div className="relative">
                    <div className="w-full h-80 bg-linear-to-br from-purple-500/20 to-cyan-500/20 rounded-2xl flex items-center justify-center border border-white/20 overflow-hidden group-hover:border-purple-500/50 transition-all">
                      <div className="text-center">
                        <div className="text-6xl font-bold bg-linear-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent mb-4">
                          ES
                        </div>
                        <p className="text-gray-400 text-sm">ElementSphere</p>
                        <p className="text-gray-500 text-xs mt-2">Next.js | Saudi Arabia</p>
                      </div>
                    </div>
                  </div>
                </div>
