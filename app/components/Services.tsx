...
import { Shield, Brain, BarChart3, Code, Palette, Server, Target, TrendingUp, Share2 } from "lucide-react";
...
export default function Services() {
  const services = [
    ...
    {
      id: 7,
      title: "Demand Generation & Prospect Development",
      icon: Target,
      ...
      description: "Strategic initiatives to identify, attract, and convert high-quality prospects into customers.",
    },
    {
      id: 8,
